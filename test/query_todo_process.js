...
console.log('---------------------------------------');
logger.info('Lets query todo process -', chaincode_id, chaincode_ver);
console.log('---------------------------------------');
...
fcw.enrollWithAdminCert(helper.makeEnrollmentOptionsUsingCert(), function (enrollErr, enrollResp) {
	if (enrollErr != null) {
		...
		console.log('---------------------------------------');
		logger.info('Now we query todo process');
		console.log('---------------------------------------');
		...
		fcw.query_chaincode(enrollResp, opts, function (err, resp) {
			console.log('---------------------------------------');
			logger.info('query todo process done. Errors:', (!err) ? 'nope' : err);
			console.log('---------------------------------------');
