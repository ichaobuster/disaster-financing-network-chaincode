...
console.log('---------------------------------------');
logger.info('Lets query paging projects -', chaincode_id, chaincode_ver);
console.log('---------------------------------------');
...
fcw.enrollWithAdminCert(helper.makeEnrollmentOptionsUsingCert(), function (enrollErr, enrollResp) {
	if (enrollErr != null) {
		...
		console.log('---------------------------------------');
		logger.info('Now we query paging projects');
		console.log('---------------------------------------');
		...
		var opts = {
			...
			cc_function: 'query_paging_projects',
		...
		fcw.query_chaincode(enrollResp, opts, function (err, resp) {
			console.log('---------------------------------------');
			logger.info('query paging projects done. Errors:', (!err) ? 'nope' : err);
			console.log('---------------------------------------');
