...
console.log('---------------------------------------');
logger.info('Lets query accessable workflows -', chaincode_id, chaincode_ver);
console.log('---------------------------------------');
logger.warn('Note: the chaincode should have been instaccessableed before running this script');
